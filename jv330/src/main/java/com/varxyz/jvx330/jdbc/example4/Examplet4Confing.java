...
@Configuration
@ComponentScan(basePackages = "com.varxyz.jvx330.jdbc.example4") //이렇게 하면 빈등록할필요가없다?
public class Examplet4Confing {
	...
	public DataSource dataSource() {
		...
		ds.setInitialSize(2);	//커넥션 풀 초기화시 생성할 초기 커넥션 객수 (기본값 10)
